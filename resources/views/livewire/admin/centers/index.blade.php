                    ...
                    <li class="col-span-1 flex flex-col text-center bg-white rounded-lg shadow divide-y divide-gray-200">
                        <div class="flex-1 flex flex-col p-8">
                            ...
                            <dl class="mt-1 flex-grow flex flex-col justify-between">
                                ...
                                <dd class="text-gray-500 text-sm">{{$center->url.'.'.config('app.base_url')}}</dd>
                            </dl>
                        </div>
                        <div>
                            <div class="-mt-px flex divide-x divide-gray-200">
                                ...
                                <div class="-ml-px w-0 flex-1 flex">
                                    <a wire:click.prevent="showEdit({{$center->id}})" href="#" class="relative w-0 flex-1 inline-flex items-center justify-center py-4 text-sm text-gray-700 font-medium border border-transparent rounded-br-lg hover:text-gray-500">
