<div class="px-5">
    ...
    <div class="bg-white shadow sm:rounded-lg w-full md:w-1/2 mx-auto">
        <div class="px-4 py-5 sm:p-6">
            ...
            <section class="mt-5 sm:flex sm:items-center sm:flex-col">
    ...
    <div class="mt-6"></div>
    @if($foundUser && !$foundUser->isInCurrentCenter())
                ...
                <div class="flex justify-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-yellow-700">
                            Il codice fiscale che ha inserito risulatà già registrato al tuo centro medico.
                        </p>
                    </div>
                </div>
            </div>
        </div>
    @elseif($searched && !$foundUser)
    <div class="w-full">
        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">
            <div class="flex justify-center">
                <div class="flex-shrink-0">
