    ...
    <div class="xl:w-1/3 lg:w-1/3 w-full flex flex-col mb-6 lg:border-b-0 border-b-2 border-gray-100 pb-5">
        <div class="flex flex-col text-center">
            ...
            <div class="w-full flex justify-between px-5 mt-5">
                ...
                <x-form.toggle entangle="divingState.swimming.amateur"/>
                <x-form.label>Agonistico</x-form.label>
                <x-form.toggle entangle="divingState.swimming.agonistic"/>
            </div>
        </div>
    </div>
    <div class="mt-6"></div>
    <div class="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col  mb-6">
        <x-form.text-input wire:model="divingState.divingComputer" label="{{ __('Modello computer subacqueo') }}"
                           autocomplete="divingComputer"/>
    </div>
    <div class="xl:w-2/5 lg:w-2/5 md:w-2/5 flex flex-col mb-6">
        <x-form.text-input type="number" wire:model="divingState.totalDives" label="{{ __('Totale immersioni') }}"
