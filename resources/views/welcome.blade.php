                    ...
                    <div class="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                        ...
                        <div class="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
                            <h1 class="text-center text-2xl font-extrabold tracking-tight sm:text-3xl lg:text-4xl">
                                <span class="block text-white">Y-40 MEDICAL CLINIC NEW</span>
                            ...
                            <div class="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
                                <div class="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-2 sm:gap-5">
                                    ...
                                    <a href="#" class="flex items-center justify-center px-4 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-indigo-700 bg-white hover:bg-indigo-50 sm:px-8">
                                        <img class="text-center h-56" src="https://storage.danavatar.eu:9000/production/images/dan-europe-logo.png"/>
            ...
            <div class="bg-gray-100">
                <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-6 grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
                        <div class="col-span-2 flex justify-center md:col-span-6 lg:col-span-5">
                            <img src="https://storage.danavatar.eu:9000/production/images/Y-40-Sponsor.jpg" alt="Tuple">
                        </div>
                    </div>
                </div>
            </div>
