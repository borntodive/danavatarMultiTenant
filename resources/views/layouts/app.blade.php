    ...
    <div class="bg-gray-200">
        ...
        <div>
            <nav x-data="{ open: false }" @keydown.window.escape="open = false" class="bg-indigo-600">
                    ...
                    <div class="flex items-center justify-between h-16">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <img class="h-8 w-8" src="{{session()->get('tenant') ? session()->get('tenant')->profile_photo_url : 'https://tailwindui.com/img/logos/workflow-mark-indigo-300.svg'}}" alt="Workflow">
                            </div>
                        ...
                        <div class="hidden md:block">
                            <div class="ml-4 flex items-center md:ml-6">
                                ...
                                <div @click.away="open = false" class="ml-3 relative" x-data="{ open: false }">
                                    <div>
                                        <button @click="open = !open" class="max-w-xs bg-indigo-600 rounded-full flex items-center text-sm text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" id="user-menu" aria-haspopup="true" x-bind:aria-expanded="open" aria-expanded="true">
                        ...
                        <div class="-mr-2 flex md:hidden">
                            <!-- Mobile menu button -->
                            <button @click="open = !open" class="bg-indigo-600 inline-flex items-center justify-center p-2 rounded-md text-indigo-200 hover:text-white hover:bg-indigo-500 hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" x-bind:aria-expanded="open">
                ...
                <div x-cloak x-description="Mobile menu, toggle classes based on menu state." x-state:on="Open" x-state:off="closed" :class="{ 'block': open, 'hidden': !open }" class="hidden md:hidden">
