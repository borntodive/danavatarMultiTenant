...
class SampleControllerSQL extends Controller
{
    ...
    public function getMeasureses(Request $request)
    {
        ...
        foreach ($rawEcgPoints as $idx=>$rawEcgPoint) {
            if ($ecgDatas[$idx]->time < $startTime) {
                continue;
            } elseif ($ecgDatas[$idx]->time > $endTime) {
                break;
            }
